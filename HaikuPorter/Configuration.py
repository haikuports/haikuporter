...
class Configuration(object):
	...
	@staticmethod
	def shallAllowNetworkInBuildChroot():
		return Configuration.configuration.allowNetworkInChroot == AllowNetworkMode.YES

	@staticmethod
	def shallAllowNetworkInTestChroot():
		return Configuration.configuration.allowNetworkInChroot != AllowNetworkMode.NO
