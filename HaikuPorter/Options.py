...
def parseOptions():
	...
	basic_actions.add_option('-g',
	                         '--get',
	                         action='store_true',
	                         dest='get',
	                         default=False,
	                         help="get/update the ports tree")
	basic_actions.add_option('-t',
	                         '--tree',
	                         action='store_true',
	                         dest='tree',
	                         default=False,
	...
	basic_actions.add_option('--list-dependencies',
	                         action='store_true',
	                         dest='listDependencies',
	                         default=False,
	                         help='list dependencies of a port')
	basic_actions.add_option('--build-master',
	                         action='store_true',
	                         dest='buildMaster',
	                         default=False,
	                         help='run as build master and delegate builds to builders')

	basic_flags = OptionGroup(parser, "Basic Options",
	                          "Basic modifications to haikuporter functionality")

	basic_flags.add_option('-o',
	                       '--location',
	                       action='store_true',
	                       dest='location',
	                       default=False,
	...
	basic_flags.add_option('-q',
	                       '--quiet',
	                       action='store_true',
	                       dest='quiet',
	                       default=False,
	                       help="suppress output from build actions")
	basic_flags.add_option('-v',
	                       '--verbose',
	                       action='store_true',
	                       dest='verbose',
	                       default=False,
	                       help="show why the recipe is broken")
	basic_flags.add_option('-y',
	                       '--yes',
	                       action='store_true',
	                       dest='yes',
	                       default=False,
	                       help="answer yes to all questions")
	basic_flags.add_option('-j',
	                       '--jobs',
	                       action='store',
	                       type="int",
	                       dest='jobs',
	...
	basic_flags.add_option('--update-dependencies',
	                       ...
	                       " then build the port")
	basic_flags.add_option('--missing-dependencies',
	                       action='store_true',
	                       dest='missingDependencies',
	                       default=False,
	                       help='build missing direct'
	...
	basic_flags.add_option('--print-raw',
	                       action='store_true',
	                       dest='printRaw',
	                       default=False,
	                       help='print machine readable output for use by scripts')

	basic_flags.add_option('--print-filenames',
	                       action='store_true',
	                       dest='printFilenames',
	                       default=False,
	...
	basic_flags.add_option('--ignore-messages',
	                       action='store_true',
	                       dest='ignoreMessages',
	                       default=False,
	                       help='ignore messages within recipes')

	advanced_flags = OptionGroup(parser, "Advanced Options",
	...
	advanced_flags.add_option('--ports-for-packages',
	                          action='store_true',
	...
	buildmaster_flags.add_option('--local-builders',
	                             action='store',
	                             type='int',
	                             dest='localBuilders',
	                             default=0,
	                             help='number of local builders (native Haiku only)')
	buildmaster_flags.add_option('--console',
	                             action='store_true',
	                             dest='display',
	                             default=False,
