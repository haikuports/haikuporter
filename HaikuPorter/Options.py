...
def parseOptions():
	...
	basic_flags.add_option('--print-raw', action='store_true', dest='printRaw',
		default=False, help='print machine readable output for use by scripts')

	basic_flags.add_option('--print-filenames', action='store_true',
		dest='printFilenames', default=False, help='print filenames instead of '
			+ 'package names in package listings and searches')

	basic_flags.add_option('--ignore-messages', action='store_true',
		dest='ignoreMessages', default=False,
		help='ignore messages within recipes')

	advanced_flags = OptionGroup(parser, "Advanced Options", "Advanced modifications to haikuporter functionality")

	advanced_flags.add_option('--cross-devel-package',
					  ...
					  help='path to the cross development package (the actual '
						   ...
						   'architecture')
	advanced_flags.add_option('--secondary-cross-devel-packages',
	...
	advanced_flags.add_option('--licenses',
	...
	advanced_flags.add_option('--system-mimedb',
	...
	advanced_flags.add_option('--cross-tools',
	...
	advanced_flags.add_option('--prune-package-repository', action='store_true',
	...
	buildmaster_flags.add_option('--system-packages-directory', action='store',
